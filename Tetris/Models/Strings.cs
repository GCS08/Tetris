namespace Tetris.Models
{
    public class Strings
    {
        ...
        public const string EmailExistsError = 
            "The email address is already in use by another account.";
        public const string OperationNotAllowedError = 
            "Unable to create an account in this method.";
        public const string WeakPasswordError = 
            "The password is too weak. It should be at least 8 characters.";
        public const string MissingEmailError = 
            "Please provide an email to create an account.";
        public const string MissingPasswordError = 
            "Please provide a password to create an account.";
        public const string InvalidEmailError = 
            "Please provide a valid email to create an account.";
        public const string InvalidCredentialsError = 
            "One of the provided credentials (email/password) was incorrect.\n" +
        ...
        public const string ManyAttemptsError = 
            "There have been too many failed attempts, and your account has been" +
            " temporarily disabled.\nPlease try again later.";
        public const string DefaultError =
            "Something went wrong, please try again later.\nIf the error " +
            "persists, contact our developer team at 'shaysol1233@gmail.com'.";
        ...
        public const string ResetPWMessage = 
        ...
        public string EmailShortErrorMessage = "The email you provided is too short.\n" +
            "Your email's minimum length must be " + ConstData.MinCharacterInEmail +
        ...
        public string PasswordShortErrorMessage = "The password you provided is too short.\n" +
            "Your password's minimum length must be " + ConstData.MinCharacterInPW +
            " characters.\nPlease re-check it and try again.";
        ...
        public const string PasswordNumberErrorMessage = "Your password must contain at " +
            "least one number.\nPlease add one (or any other number) and try again.";
        public const string PasswordNumberErrorButton = "5ure!";
        public const string PasswordLowerCaseErrorTitle = 
            "Password doesn't have a lower-case letter:";
        public const string PasswordLowerCaseErrorMessage = 
            "Your password must contain at least one lower-case letter.\n" +
            "Please add one and try again.";
        public const string PasswordLowerCaseErrorButton = "SURE!";
        public const string PasswordUpperCaseErrorTitle = 
            "Password doesn't have an upper-case letter:";
        public const string PasswordUpperCaseErrorMessage = 
        ...
        public string UserNameShortErrorMessage = "The username you provided is too short.\n" +
            "Your username's minimum length must be " + ConstData.MinCharacterInUN + 
            " characters.\nPlease re-check it and try again.";
        ...
        public const string NotificationContent = "Come on! Align those blocks " +
            "before they stack to the top of the board :(";
        ...
        public const string UserNameNumberErrorMessage =
        ...
        public const string NotificationChannelDescription = 
            "The default channel for notifications.";
        public const string AlarmReceiverBroadcastLabel = 
            "Local Notifications Broadcast Receiver";
